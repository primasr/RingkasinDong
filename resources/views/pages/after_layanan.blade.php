...
@section('title', 'Send Data Success')
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center mb-5">
            <h1 data-aos="fade-up" style="color: green">Pengiriman data Berhasil.</h1>            
            <h2 data-aos="fade-up" style="color: rgb(24, 104, 24)">Mohon tunggu informasi masuk ke email yang Anda daftarkan (Maksimal 1x24 jam)</h2>
          </div>
        </div>
      </div>
    </div>
