      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center mb-5">
            <h1 data-aos="fade-up" style="color: red">Koin Anda tidak mencukupi!</h1>
            <h2 data-aos="fade-up">Silahkan lakukan top up <a href="{{ route('topup') }}">disini</a></h2>
          </div>
        </div>
      </div>
    </div>
